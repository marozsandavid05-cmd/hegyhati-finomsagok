/* ==========================================================================
   ...
   Mezők:
     ...
     photos    : ['media/products/<file>', ...] SORREND KÖTELEZŐ: egészben (fő kép), elvágva, szelet
                 (Kinga 2026-09-17: a fő kép SOHA ne a szeletelt legyen); a -thumb változat a kártyán
                 ha nincs photos: brand-csempe „Fotó hamarosan" (fotó kérése az ügyféltől)
     photoInfo : 'illus' = csak illusztráció-kép van (saját fotó kérendő)
                 'partial' = valódi fotó, de nincs meg mind a 3 nézet
                 (a termékoldal a galéria alatt kiírja, hogy hamarosan várható a fotó)
...
const PRODUCTS = [
  ...
  { id: 'mangalica-sonka', name: 'Mangalica sonka', category: 'sonka', animal: 'mangalica', price: 5000,
    ...
    photos: ['media/products/mangalica-sonka-szalonna.webp'], photoInfo: 'illus',
  ...
  { id: 'szivsonka', name: 'Szívsonka', category: 'sonka', animal: 'sertes', price: 4500,
    ...
    photos: ['media/products/szivsonka.webp'], photoInfo: 'illus',
  ...
  { id: 'comb-hus', name: 'Comb hús', category: 'sonka', animal: 'sertes', price: 5000,
    weight: W_DEFAULT, piece: null, featured: false, options: { spice: null, sliceable: true },
    photos: ['media/products/comb-hus.webp'], photoInfo: 'partial',
  ...
  { id: 'mangalica-szalonna', name: 'Mangalica szalonna', category: 'szalonna', animal: 'mangalica', price: 6400,
    weight: W_DEFAULT, piece: null, featured: false, options: { spice: null, sliceable: true },
    photos: ['media/products/mangalica-szalonna.webp'], photoInfo: 'partial',
  ...
  { id: 'angol-szalonna', name: 'Angol szalonna', category: 'szalonna', animal: 'sertes', price: 4200,
    weight: W_DEFAULT, piece: null, featured: false, options: { spice: null, sliceable: true },
    photos: ['media/products/angol-szalonna-3.webp', 'media/products/angol-szalonna.webp', 'media/products/angol-szalonna-2.webp'],
  ...
  { id: 'csaszar-szalonna', name: 'Császárszalonna', category: 'szalonna', animal: 'sertes', price: 4500,
    weight: W_DEFAULT, piece: null, featured: false, options: { spice: null, sliceable: true },
    photos: ['media/products/csaszar-szalonna-3.webp', 'media/products/csaszar-szalonna.webp', 'media/products/csaszar-szalonna-2.webp'],
  ...
  { id: 'mangalica-angol-szalonna', name: 'Mangalica angol szalonna', category: 'szalonna', animal: 'mangalica', price: 4000,
    weight: W_DEFAULT, piece: null, featured: false, options: { spice: null, sliceable: true },
    photos: ['media/products/mangalica-angol-szalonna.webp'], photoInfo: 'illus',
  ...
  { id: 'kenyerszalonna', name: 'Kenyérszalonna', category: 'szalonna', animal: 'sertes', price: 3200,
    ...
    photos: ['media/products/kenyerszalonna.webp'], photoInfo: 'illus',
  ...
  { id: 'paprikas-tokaszalonna', name: 'Paprikás főtt tokaszalonna', category: 'szalonna', animal: 'sertes', price: 2300,
    weight: W_DEFAULT, piece: null, featured: false, options: { spice: null, sliceable: true },
    photos: ['media/products/paprikas-tokaszalonna-3.webp', 'media/products/paprikas-tokaszalonna.webp', 'media/products/paprikas-tokaszalonna-2.webp'],
  ...
  { id: 'sult-csaszar', name: 'Sült császár', category: 'szalonna', animal: 'sertes', price: 3900,
    weight: W_DEFAULT, piece: null, featured: false, options: { spice: null, sliceable: true },
    photos: ['media/products/sult-csaszar.webp'], photoInfo: 'illus',
  ...
  { id: 'sertes-kolbasz', name: 'Sertéskolbász', category: 'kolbasz', animal: 'sertes', price: 4000,
    ...
    photos: ['media/products/sertes-kolbasz-3.webp', 'media/products/sertes-kolbasz-2.webp', 'media/products/sertes-kolbasz.webp'],
  ...
  { id: 'sutokolbasz', name: 'Sütőkolbász', category: 'kolbasz', animal: 'sertes', price: 3800,
    ...
    photos: ['media/products/sutokolbasz.webp'], photoInfo: 'partial',
  ...
  { id: 'hurka', name: 'Hurka', category: 'kolbasz', animal: 'sertes', price: 2300,
    ...
    photos: ['media/products/hurka.webp'], photoInfo: 'partial',
  ...
  { id: 'mangalica-stifolder', name: 'Mangalica stifolder', category: 'szalami', animal: 'mangalica', price: 6300,
    ...
    photos: ['media/products/mangalica-stifolder-3.webp', 'media/products/mangalica-stifolder.webp', 'media/products/mangalica-stifolder-2.webp'],
  ...
  { id: 'sertes-stifolder', name: 'Sertés stifolder', category: 'szalami', animal: 'sertes', price: 5500,
    ...
    photos: ['media/products/sertes-stifolder-3.webp', 'media/products/sertes-stifolder.webp', 'media/products/sertes-stifolder-2.webp'],
  ...
  { id: 'kulen', name: 'Kulen', category: 'szalami', animal: 'sertes', price: 6000,
    ...
    photos: ['media/products/kulen-3.webp', 'media/products/kulen-2.webp', 'media/products/kulen.webp'],
  ...
  { id: 'borokas-feltet', name: 'Borókás feltét', category: 'szalami', animal: 'sertes', price: 5000,
    ...
    photos: ['media/products/borokas-feltet.webp'], photoInfo: 'partial',
  ...
  { id: 'borokas-stifolder', name: 'Borókás stifolder', category: 'szalami', animal: 'sertes', price: 6000,
    ...
    photos: ['media/products/borokas-stifolder-3.webp', 'media/products/borokas-stifolder.webp', 'media/products/borokas-stifolder-2.webp'],
  ...
  { id: 'marha-stifolder', name: 'Marha stifolder', category: 'szalami', animal: 'marha', price: 7000,
    weight: W_DEFAULT, piece: { label: 'db', kg: 0.7, max: 6 }, featured: true, options: { spice: ['csemege', 'csípős'], sliceable: true },
    photos: ['media/products/marha-stifolder-3.webp', 'media/products/marha-stifolder-2.webp', 'media/products/marha-stifolder.webp'],
  ...
  { id: 'bivaly-stifolder', name: 'Bivaly stifolder', category: 'szalami', animal: 'bivaly', price: 7000,
    weight: W_DEFAULT, piece: { label: 'db', kg: 0.7, max: 6 }, featured: false, options: { spice: ['csemege', 'csípős'], sliceable: true },
    photos: ['media/products/bivaly-stifolder.webp'], photoInfo: 'illus',
  ...
  { id: 'fustolt-elso-csulok', name: 'Füstölt első csülök', category: 'pacolt-hus', animal: 'sertes', price: 2800,
    ...
    photos: ['media/products/fustolt-elso-csulok.webp'], photoInfo: 'partial',
  ...
  { id: 'fustolt-hatso-csulok', name: 'Füstölt hátsó csülök', category: 'pacolt-hus', animal: 'sertes', price: 3500,
    ...
    photos: ['media/products/fustolt-hatso-csulok.webp'], photoInfo: 'partial',
  ...
  { id: 'fustolt-karaj', name: 'Füstölt karaj', category: 'pacolt-hus', animal: 'sertes', price: 4800,
    weight: W_DEFAULT, piece: null, featured: false, options: { spice: null, sliceable: true },
    photos: ['media/products/fustolt-karaj-4.webp', 'media/products/fustolt-karaj-3.webp', 'media/products/fustolt-karaj-2.webp'],
  ...
  { id: 'fustolt-tarja', name: 'Füstölt tarja', category: 'pacolt-hus', animal: 'sertes', price: 4800,
    weight: W_DEFAULT, piece: null, featured: false, options: { spice: null, sliceable: true },
    photos: ['media/products/fustolt-tarja-3.webp', 'media/products/fustolt-tarja-2.webp', 'media/products/fustolt-tarja.webp'],
  ...
  { id: 'erlelt-tarja', name: 'Érlelt tarja', category: 'pacolt-hus', animal: 'sertes', price: 5200,
    weight: W_DEFAULT, piece: null, featured: false, options: { spice: null, sliceable: true },
    photos: ['media/products/erlelt-tarja.webp'], photoInfo: 'illus',
  ...
  { id: 'erlelt-marha-comb', name: 'Érlelt marha comb', category: 'pacolt-hus', animal: 'marha', price: 8000,
    weight: W_DEFAULT, piece: null, featured: false, options: { spice: null, sliceable: true },
    photos: ['media/products/erlelt-marha-comb-3.webp', 'media/products/erlelt-marha-comb.webp', 'media/products/erlelt-marha-comb-2.webp'],
  ...
  { id: 'fustolt-oldalas', name: 'Füstölt oldalas', category: 'pacolt-hus', animal: 'sertes', price: 2800,
    ...
    photos: ['media/products/fustolt-oldalas.webp'], photoInfo: 'illus',
  ...
  { id: 'toltott-fustolt-szuzpecsenye', name: 'Töltött füstölt szűzpecsenye', category: 'pacolt-hus', animal: 'sertes', price: 3800,
    ...
    photos: ['media/products/toltott-szupecsenye.webp'], photoInfo: 'illus',
  ...
  { id: 'csipszes-teperto', name: 'Csipszes tepertő', category: 'teperto', animal: 'sertes', price: 9000,
    ...
    photos: ['media/products/teperto-chips.webp'], photoInfo: 'illus',
  ...
  { id: 'hagyomanyos-teperto', name: 'Hagyományos tepertő', category: 'teperto', animal: 'sertes', price: 5500,
    ...
    photos: ['media/products/hagyomanyos-teperto.webp'], photoInfo: 'illus',
  ...
  { id: 'parasztmajas', name: 'Paraszt májas', category: 'majas', animal: 'sertes', price: 3600,
    ...
    photos: ['media/products/parasztmajas.webp'], photoInfo: 'illus',
    desc: 'Kenhető, sűrű, fűszeres májas, a ház egyik büszkesége. Pirítósra vastagon, savanyúsággal mellé. Saját recept, sehol máshol.' },
];

/* ---- kategória + fajta kombinációk: saját, hirdethető tiszta URL (/mangalica-szalonna) ---- */
const COMBOS = (function () {
  const out = [];
  for (const c of CATEGORIES) {
    const inCat = PRODUCTS.filter(p => p.category === c.id);
    for (const a of ANIMALS) {
      const items = inCat.filter(p => p.animal === a.id);
      if (!items.length) continue;
      out.push({
        slug: a.id + '-' + c.slug,
        category: c.id,
        animal: a.id,
        name: a.name + ' ' + c.name.toLowerCase(),
        count: items.length,
        whole: items.length === inCat.length,
      });
    }
  }
  return out;
})();
function getCombo(catId, animalId) { return COMBOS.find(x => x.category === catId && x.animal === animalId) || null; }
function comboBySlug(slug) { return COMBOS.find(x => x.slug === slug) || null; }
function animalsInCategory(catId) { return [...new Set(PRODUCTS.filter(p => p.category === catId).map(p => p.animal))]; }
...
window.HFDATA = { CATEGORIES, ANIMALS, PRODUCTS, COMBOS, STEP, getProduct, getCategory, getAnimal, getCombo, comboBySlug, animalsInCategory, mainPhoto, thumbPhoto, normalize, searchIndex };
